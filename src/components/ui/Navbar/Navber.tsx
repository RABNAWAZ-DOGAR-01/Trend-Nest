       ...
       <nav className="hidden gap-12 lg:flex 2xl:ml-16">
        {links.map((link, idx) => (
          <div key={idx}>
            {pathname === link.href ? (
              <Link
                className="text-lg text-blue-500 font-semibold -bg-black"
                href={link.href}
              >
                {link.name}
              </Link>
              ...
              <Link
                href={link.href}
                className="text-lg font-semibold text-gray-600 transition duration-300 hover:text-primary -bg-black"
              >
                {link.name}
              </Link>
            )}
